...
set(command "E:/Program Files/CMake/bin/cmake.exe;-DCMAKE_BUILD_TYPE=;-Dgtest_force_shared_crt=ON;-Dgtest_disable_pthreads:BOOL=OFF;-DBUILD_GTEST=ON;-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG:PATH=DebugLibs;-DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE:PATH=ReleaseLibs;-GVisual Studio 16 2019;-DCMAKE_GENERATOR_INSTANCE:INTERNAL=E:/Program Files/Visual Studio/2019/Community;F:/OpenGL/assimp_build/test/gtest/src/gtest")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-configure-out.log")
set(stderr_log "F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  endif()
  ...
  if(NOT "Visual Studio 16 2019" MATCHES "Ninja")
    set(msg "gtest configure command succeeded.  See also F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
