...
set(command "E:/Program Files/CMake/bin/cmake.exe;--build;.;--config;RelWithDebInfo")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-build-out.log")
set(stderr_log "F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-build-*.log")
  endif()
  ...
  if(NOT "Visual Studio 16 2019" MATCHES "Ninja")
    set(msg "gtest build command succeeded.  See also F:/OpenGL/assimp_build/test/gtest/src/gtest-stamp/gtest-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
